...
<div class="row clearfix">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        <div class="row clearfix">
          <form action="<?=base_url('consoleApi/editBanquet');?>" method="POST" enctype= multipart/form-data>
          <input type="hidden" name="b_id" value="<?=$banquet['id']?>">
            <div class="col-sm-12">
              <label for="">方案主圖</label>
              
              <div class="form-group">
                    <div class="col-sm-12 p-l-0 p-r-0"><img src="<?=$banquet['img_url']?>" alt="" class="col-xs-8 col-sm-4 p-l-0 p-r-0 img-preview"></div>
              ...
              <div class="form-group">
                  <div class="form-line">
                      <input type="text" class="form-control" name="title" value="<?=$banquet['title']?>" required>
                  </div>
              </div>
              <label class="form-label">方案價格 (元/桌起)</label>
              <div class="form-group">
                  <div class="form-line">
                      <input type="number" class="form-control" name="money" value="<?=$banquet['money']?>" required>
                  </div>
              </div>
              <label class="form-label">詳細介紹</label>
              <div class="form-group">
                  <div class="form-line">
                    <textarea rows="4" class="form-control no-resize" name="detail" required><?=$banquet['detail']?></textarea>
                  </div>
              </div>
