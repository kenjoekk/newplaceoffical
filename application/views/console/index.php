...
<body class="theme-red">
    ...
    <!-- ChartJs -->
    <script src="<?php echo base_url('assets/console/plugins/chartjs/Chart.bundle.js')?>"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="<?php echo base_url('assets/console/plugins/flot-charts/jquery.flot.js')?>"></script>
    <script src="<?php echo base_url('assets/console/plugins/flot-charts/jquery.flot.resize.js')?>"></script>
    <script src="<?php echo base_url('assets/console/plugins/flot-charts/jquery.flot.pie.js')?>"></script>
    <script src="<?php echo base_url('assets/console/plugins/flot-charts/jquery.flot.categories.js')?>"></script>
    <script src="<?php echo base_url('assets/console/plugins/flot-charts/jquery.flot.time.js')?>"></script>
    ...
    <script src="<?php echo base_url('assets/console/js/pages/index.js')?>"></script>
